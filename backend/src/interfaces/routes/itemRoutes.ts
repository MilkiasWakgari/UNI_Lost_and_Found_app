...
router.post("/", (req: Request, res: Response, next: NextFunction) =>
  itemController.createItem(req as any, res, next)
);
router.get("/found", (req: Request, res: Response, next: NextFunction) =>
  itemController.getItemsByFoundBy(req as any, res, next)
);
router.get("/claimed", (req: Request, res: Response, next: NextFunction) =>
  itemController.getItemsByClaimedBy(req as any, res, next)
);
...
router.post("/:id/claim", (req: Request, res: Response, next: NextFunction) =>
  itemController.claimItem(req as any, res, next)
);
router.post("/:id/return", (req: Request, res: Response, next: NextFunction) =>
  itemController.markAsReturned(req, res, next)
);
