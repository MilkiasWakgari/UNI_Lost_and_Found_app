...
class ItemController {
    ...
    async getAllItems(req, res, next) {
        try {
            ...
            res.status(500).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to fetch items' });
        }
    }
    async getItemById(req, res, next) {
        try {
            ...
            res.status(500).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to fetch item' });
        }
    }
    ...
    async updateItem(req, res, next) {
        try {
            ...
            res.status(400).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to update item' });
        }
    }
    async deleteItem(req, res, next) {
        try {
            ...
            res.status(500).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to delete item' });
        }
    }
    async getRecentItems(req, res, next) {
        try {
            ...
            res.status(500).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to fetch recent items' });
        }
    }
    async getTodayItems(req, res, next) {
        try {
            ...
            res.status(500).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to fetch today\'s items' });
        }
    }
    ...
    async markAsReturned(req, res, next) {
        try {
            ...
            res.status(400).json({ message: (error === null || error === void 0 ? void 0 : error.message) || 'Failed to mark item as returned' });
        }
    }
}
